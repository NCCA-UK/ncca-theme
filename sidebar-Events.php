...
<?php		// Widgetized sidebar
		if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('events') ) : ?>
			    ...
			    <ul>
				<?php _e("To edit this sidebar, go to admin backend's <strong><em>Appearance -> Widgets</em></strong> and place widgets into the <strong><em>Events Sidebar</em></strong> Widget Area", 'udesign'); ?>
			    </ul>
			</div>
